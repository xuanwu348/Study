...
class ui:
    def __init__(self):
        ...
        #In cbreak mode (sometimes called “rare” mode) normal tty line buffering is turned off i
        #and characters are available to be read one by one. 
        curses.cbreak()

        #visibility can be set to 0, 1, or 2, for invisible, normal, or very visible. 
        #If the terminal supports the visibility requested, the previous cursor state is returned; 
        #otherwise, an exception is raised. On many terminals, the “visible” mode is an underline cursor 
        ...
        self.win2 = curses.newwin(10,50,0,55)
        self.win2.border(0)
